...
PATH_PREDS_CORRECTED = os.path.join(*list(PurePath('../annotations/predictions_corrected').parts))
...
def main():
    ...
    pred_files, rel_paths = get_images_predictions(PATH_IMAGES, PATH_PREDS, PATH_PREDS_CORRECTED)
